...
extension [LevelPagesBuilder] {
    static var allData: Self {
        [
            ...
            .init(title: "2", name: "Africa", zoom: 1, mapPosition: .init(x: -0.4, y: -0.3), appearence: .init(backgroundColor: .white, secondaryColor: .white, backgroundTextureName: "blueGround", enemyGroundTextureName: "darkGround"), levels: [
                .init(position:
                        .init(x: 0.12, y: 0.16),
                      title: "201"),
                .init(position:
            ...
            .init(title: "3", name: "Europe", zoom: 0.7, mapPosition: .init(x: -0.44, y: -0.03), appearence: .init(backgroundColor: .container, secondaryColor: .white, backgroundTextureName: "grass", enemyGroundTextureName: "enemyGroundBrawn"), levels: [
                .init(position:
                        .init(x: 0.2, y: 0.6),
                      title: "301"),
                .init(position:
